<template>
  <el-row v-loading="loading">
    ...
    <el-col :span="8" :offset="8" style="margin-top:20px;margin-bottom:20px">
      <el-pagination @current-change="changePage" background layout="prev, pager, next" :total="total" :page-size="perPage" :current-page="currentPage">
      </el-pagination>
    </el-col>
        ...
        <el-form-item  label="name" prop="name">
          ...
          <el-form-item label="提醒时间">
            <el-select v-model="form.remind_time">
              <el-option v-for="(item,key) in 10" :key="key" :label="5*item+'天'" :value="5*item"></el-option>
              
            </el-select>
          </el-form-item>
          <el-form-item>
            <el-button v-if="action=='add'" type="primary">提交</el-button>
